...
help: ## Show this help message
	...
	@echo "  make save       - Commit + push config changes (no rebuild) ONLY use this if you did not change .nix files!"
...
deploy: ## Rebuild everything, commit and push if successful
	...
	@if sudo nixos-rebuild switch --flake ~/nixos#$(hostname); then \
		echo ""; \
